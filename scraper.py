...
for tid in tids:
  ...
  ani['ko-title'] = None
  ani['premiered'] = soup.select_one('#tidContainer > div.tidTabContentLayout > div.tidSidebar > div > table.section.basic > tbody > tr > td > table > tbody > tr:nth-child(3) > td').get_text().split('～')[0]
  ani['bookmark'] = None
