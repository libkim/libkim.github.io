...
for tid in tids:
  ...
  ani['ko-title'] = None
  premiered = "{}".format(soup.select_one('#tidContainer > div.tidTabContentLayout > div.tidSidebar > div > table.section.basic > tbody > tr > td > table > tbody > tr:nth-child(3) > td'))
  ani['premiered'] = premiered.get_text().split('～')[0]
  ani['bookmark'] = None
